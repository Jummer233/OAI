...
#define CONFIG_HLP_CHESTFREQ                                                                                                       \
  "Set channel estimation type in frequency domain. 0-Linear interpolation (default). 1-PRB based averaging of channel estimates " \
  "in frequency. \n"
#define CONFIG_HLP_CHESTTIME                                                                                                    \
  "Set channel estimation type in time domain. 0-Symbols take estimates of the last preceding DMRS symbol (default). 1-Symbol " \
...
#define CONFIG_HLP_PARALLEL_CMD \
...
#define CONFIG_HLP_USRP_THREAD "having extra thead for usrp tx\n"
#define CONFIG_HLP_NFAPI \
  "Change the nFAPI mode for NR 'MONOLITHIC', 'PNF', 'VNF', 'AERIAL','UE_STUB_PNF','UE_STUB_OFFNET','STANDALONE_PNF'\n"
...
#define CMDLINE_PARAMS_DESC {  \
  ...
  {"thread-pool",           CONFIG_HLP_TPOOL,         0,              .strptr=&TP_CONFIG,                     .defstrval="30,31,32,33,34,35,36,37",  TYPE_STRING, 0},     \
...
#define MAPPING_SOFTMODEM_FUNCTIONS                                                       \
  {                                                                                       \
    {"enb", SOFTMODEM_ENB_BIT}, {"gnb", SOFTMODEM_GNB_BIT}, {"4Gue", SOFTMODEM_4GUE_BIT}, \
    {                                                                                     \
      "5Gue", SOFTMODEM_5GUE_BIT                                                          \
    }                                                                                     \
  }
